...
import br.akd.svc.akadia.models.dto.sistema.colaboradores.mocks.ColaboradorDtoBuilder;
...
class ColaboradorDtoTest {
    ...
    void deveTestarDataBuilder() {
        Assertions.assertEquals(
                "ColaboradorDto(id=1, dataCadastro=2023-02-13, horaCadastro=10:44, fotoPerfil=[], " +
                        ...
                        "telefone=null, expediente=null, dispensa=null, pontos=null, historicoFerias=null, " +
                        "advertencias=null, parentescos=null, empresa=null)",
                ColaboradorDtoBuilder.builder().build().toString()
        );
    }
    ...
    void deveTestarAllArgsConstructor() {
        ...
        Assertions.assertEquals(
                "ColaboradorDto(id=1, dataCadastro=2023-02-13, horaCadastro=11:17, fotoPerfil=[], " +
                        ...
                        "dispensa=null, pontos=[], historicoFerias=[], advertencias=[], parentescos=[], empresa=null)",
    ...
    void deveTestarBuilder() {
        ColaboradorDto colaboradorDto = ColaboradorDto.builder()
                ...
                .build();
        Assertions.assertEquals(
                "ColaboradorDto(id=1, dataCadastro=2023-02-13, horaCadastro=11:18, fotoPerfil=[], " +
