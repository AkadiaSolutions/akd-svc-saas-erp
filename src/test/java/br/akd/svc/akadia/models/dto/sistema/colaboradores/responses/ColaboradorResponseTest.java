...
class ColaboradorResponseTest {
    ...
    void deveTestarDataBuilder() {
        Assertions.assertEquals(
                "ColaboradorResponse(id=1, dataCadastro=2023-02-13, horaCadastro=10:44, matricula=123456, " +
                        ...
                        "statusColaboradorEnum=ATIVO, fotoPerfil=null, exclusao=null, acessoSistema=null, " +
                        "configuracaoPerfil=null, contratoContratacao=null, endereco=null, telefone=null, " +
                        "expediente=null, dispensa=null, pontos=[], historicoFerias=[], advertencias=[])",
                ColaboradorResponseBuilder.builder().build().toString()
        );
    ...
    void deveTestarAllArgsConstructor() {
        ...
        Assertions.assertEquals(
                "ColaboradorResponse(id=1, dataCadastro=2023-02-13, horaCadastro=11:17, matricula=123456, " +
                        ...
                        "statusColaboradorEnum=FERIAS, fotoPerfil=null, exclusao=null, acessoSistema=null, " +
                        "configuracaoPerfil=null, contratoContratacao=null, endereco=null, telefone=null, " +
                        "expediente=null, dispensa=null, pontos=[], historicoFerias=[], advertencias=[])",
    ...
    void deveTestarBuilder() {
        ColaboradorResponse colaboradorResponse = ColaboradorResponse.builder()
                ...
                .build();
        Assertions.assertEquals(
                "ColaboradorResponse(id=1, dataCadastro=2023-02-13, horaCadastro=11:18, matricula=123456, " +
                        ...
                        "exclusao=null, acessoSistema=null, configuracaoPerfil=null, contratoContratacao=null, " +
